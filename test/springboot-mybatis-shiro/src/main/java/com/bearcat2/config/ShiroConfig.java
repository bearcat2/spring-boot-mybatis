...
// shiroFilterFactoryBean对象
		...
		// 指定要求登录时的链接
		shiroFilterFactoryBean.setLoginUrl("/sysUser/doLogin");
		// 登录成功后要跳转的链接
		...
		// 配置记住我或认证通过可以访问的地址
		filterChainDefinitionMap.put("/sysUser/list", "user");
...
//		filterChainDefinitionMap.put("/sysUser/login", "anon");
		...
		filterChainDefinitionMap
				.put("/sysUser/delete", "authc,perms[用户管理]");
		//
